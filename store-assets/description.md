...
📈 **Dashboard side panel** — rating distribution, trust breakdown, review timeline, detected patterns, practical recommendations, and 11 smart filters (suspicious, AI-like, verified, most helpful, and more).

📤 **Export** — save any analysis as JSON, CSV, or a clean printable PDF report.

⚙️ **Fully configurable** — per-site toggles, sensitivity slider, analysis depth, auto-scan, highlighting, dark/light/system theme, notifications with a custom threshold, and searchable scan history.

**Privacy first — really**

- All analysis runs locally in your browser. Nothing is ever sent to any server.
- No accounts, no tracking, no telemetry, no ads.
- Your scan history and settings live only in your browser's extension storage and can be wiped with one click.

**Supported sites**

- Amazon (.com, .co.uk, .de, .fr, .es, .it, .ca) — product review pages
- Google — Maps and Search business reviews
...
1. "Instant Trust Index for any Amazon or Google review page"
2. "Suspicious reviews highlighted on the page, with reasons on hover"
3. "Full dashboard: charts, patterns, recommendations and filters"
4. "Export a clean PDF trust report"
5. "Private by design — everything runs locally"
