 ...
 *
 * Parameters live in weights.ts, which is generated by `npm run train`.
 * The text weights are trained on a labeled corpus; the behavioral and
 * author-history weights are domain priors, because a text-only corpus
 * cannot estimate them. BIAS is recalibrated to the deployment prior.
 * Accuracy figures and the reasoning behind both decisions: docs/MODEL.md.
 */
